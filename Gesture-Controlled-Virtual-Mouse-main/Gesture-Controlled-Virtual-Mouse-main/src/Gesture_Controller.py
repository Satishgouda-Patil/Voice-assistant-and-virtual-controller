...
#extra+++++++++++++++++++++++++++++++++++++++++++++++++++++
def apply_vintage_effect(image, x, y, radius=50):
    """
    Apply a sepia-tone vintage effect around the cursor position (x, y).
    ...
    radius : int
        Radius of the effect (default 50px).
    
    Returns
    -------
    image : ndarray
        The image with the sepia effect applied around the pointer.
    """
    # Create a circular mask
    overlay = image.copy()
    cv2.circle(overlay, (x, y), radius, (80, 50, 20), -1)  # Sepia color overlay
